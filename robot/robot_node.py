...
class RobotNode(object):
    def __init__(self):
        ...
        self.tf_broadcaster.sendTransform((0.,0.,0.),(0.,0.,0.,0.), rospy.Time.now(), "base_link", "odom")
    ...
    def publish_transform(self, velocity_message=None):
        ...
        if velocity_message != None:
            ...
            rospy.loginfo('Velocity received ' + str(linear_x_velocity) + ' ' + str(linear_y_velocity) + ' ' + str(angular_velocity))
